    ...
    return (
        <div ref={aboutRef} className="pt-30 max-w-[1440px] mx-auto px-8 space-y-5 md:px-8">
            ...
            <div className="my-20 flex items-center">
                <button className="bg-[#9dd290] text-black font-extralight rounded-sm text-xl px-8 py-4 uppercase cursor-pointer"><a href="https://drive.google.com/file/d/1yHURSIqfMDNlct1AR-AW9ugTtUi9OeJl/view?usp=sharing" target="_blank">Get my cv</a></button>
